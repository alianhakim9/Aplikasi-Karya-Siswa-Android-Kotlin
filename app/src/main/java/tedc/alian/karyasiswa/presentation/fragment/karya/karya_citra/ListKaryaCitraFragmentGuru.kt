...
@AndroidEntryPoint
class ListKaryaCitraFragmentGuru : BaseFragment<FragmentListKaryaCitraBinding>(),
    ...
    private fun setupRecyclerView() {
        ...
        binding.rvListKaryaCitra.apply {
            ...
            this.adapter = this@ListKaryaCitraFragmentGuru.adapter.withLoadStateHeaderAndFooter(
                header = ListKaryaCitraLoadStateAdapter {
                    this@ListKaryaCitraFragmentGuru.adapter.retry()
                },
    ...
    override fun onItemClick(karyaCitra: KaryaCitraDto) {
        val action =
            ListKaryaCitraFragmentGuruDirections.actionListKaryaCitraFragmentGuruToDetailKaryaCitraFragment2(
                karyaCitra.id
            )
