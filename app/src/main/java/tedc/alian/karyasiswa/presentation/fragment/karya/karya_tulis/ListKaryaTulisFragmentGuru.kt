...
@AndroidEntryPoint
class ListKaryaTulisFragmentGuru : BaseFragment<FragmentListKaryaTulisBinding>(),
    ...
    private fun setupRecyclerView() {
        binding.rvKaryaTulis.apply {
            ...
            this.adapter = this@ListKaryaTulisFragmentGuru.adapter.withLoadStateHeaderAndFooter(
                header = ListKaryaTulisLoadStateAdapter {
                    this@ListKaryaTulisFragmentGuru.adapter.retry()
                },
    ...
    override fun onItemClick(karyaTulis: KaryaTulisDto) {
        val action =
            ListKaryaTulisFragmentGuruDirections.actionListKaryaTulisFragmentGuruToDetailKaryaTulisFragmentGuru(
                karyaTulis.id
            )
